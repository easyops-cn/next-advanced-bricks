...
```tsx
import { WrappedAiPortalElevoCard } from "@easyops/wrapped-components";
```
  ...
  >
    <WrappedEoDropdownActions
      ...
      actions={[
        ...
        { text: "Delete", event: "delete", danger: true },
      ]}
    >
    ...
    <WrappedEoButton slot="footer" themeVariant="elevo" type="flat">
      Chat
    </WrappedEoButton>
  </WrappedAiPortalElevoCard>
</WrappedAiPortalHomeContainer>
...
<WrappedAiPortalHomeContainer>
  <WrappedAiPortalElevoCard
    ...
    avatarType="icon"
    avatar={{ lib: "antd", icon: "monitor", color: "blue" }}
    url="/monitor"
    style={{ maxWidth: 400 }}
  />
</WrappedAiPortalHomeContainer>
