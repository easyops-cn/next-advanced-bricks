...
const en: Locale = {
  ...
  REMOVED_GOAL_MEMBERS: "removed a goal member: ",
  REMOVED_GOAL_MEMBERS_plural: "removed {{ count }} goal members: ",
  ADDED_GOAL_MEMBERS: "added a goal member: ",
  ADDED_GOAL_MEMBERS_plural: "added {{ count }} goal members: ",
  COMMENTED: "commented",
  COMMA: ", ",
  SEMICOLON: "; ",
};
...
const zh: Locale = {
  ...
  REMOVED_GOAL_MEMBERS: "移除了目标参与成员：",
  ADDED_GOAL_MEMBERS: "添加了目标参与成员：",
  COMMENTED: "评论",
  COMMA: "，",
  SEMICOLON: "；",
};
