...
export enum K {
  ...
  STOP_THE_TASK = "STOP_THE_TASK",
  CONFIRM_TO_STOP_THE_TASK_TITLE = "CONFIRM_TO_STOP_THE_TASK_TITLE",
  CONFIRM_TO_STOP_THE_TASK_CONTENT = "CONFIRM_TO_STOP_THE_TASK_CONTENT",
...
const en: Locale = {
  ...
  STOP_THE_TASK: "Stop the task",
  CONFIRM_TO_STOP_THE_TASK_TITLE: "Are you sure to stop the task?",
  CONFIRM_TO_STOP_THE_TASK_CONTENT:
    "The task can not be resumed after been stopped.",
...
const zh: Locale = {
  ...
  STOP_THE_TASK: "停止任务",
  CONFIRM_TO_STOP_THE_TASK_TITLE: "确定终止任务吗？",
  CONFIRM_TO_STOP_THE_TASK_CONTENT: "任务终止后将无法再恢复运行。",
